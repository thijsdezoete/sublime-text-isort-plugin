...
Available in [@wbond][wbond]'s [package control][package-control].  Just bring up the package control menu in sublime (default `ctrl-shift-p`), and enter `Package Control: Install Package`, search for `isort`.
...
[![Bitdeli Badge](https://d2weczhvl823v0.cloudfront.net/thijsdezoete/sublime-text-isort-plugin/trend.png)](https://bitdeli.com/free "Bitdeli Badge")
